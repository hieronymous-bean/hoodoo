<template>
  <div class="absolute top-0 right-0 z-10 my-10">
    <div class="bg-white rounded overflow-hidden shadow-lg">
      <div class="text-center p-6  border-b">
        <img
          ...
          alt="Randy Robertson"
        />
        <p class="pt-2 text-lg font-semibold">Firstname Lastname</p>
        <p class="text-sm text-gray-600">jeffrey@mcgaw.io</p>
        <div class="mt-5">
          <a class="border rounded-full py-2 px-4 text-xs font-semibold text-gray-700">
            Settings
          </a>
        </div>
      </div>
